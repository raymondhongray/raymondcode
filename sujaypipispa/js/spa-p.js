...
function onYouTubeIframeAPIReady(){
      ...
      console.log('youtube');
      player1 = new YT.Player('player-p', {
          height: '100%',
          width: '100%',
...
function onPlayerStateChange(event) {
    ...
    if(event.data == YT.PlayerState.ENDED){
      ...
      ga( 'send', 'event', '次頁-怡人香香館', 'Click', '播放影片' );
    }
...
$(document).ready(function(){
  ...
  $('.share-btn').click(function(){
      FB.ui({
        ...
        link: window.location.hostname+'/youtubep.html',
        description: '全亞洲第一間PIPI SPA中心館長到底在堅持什麼？全天下最愉悅的香氛體驗，他找的到嗎？',
        // caption: '大家都愛擦屁屁',
        picture: window.location.hostname+"/img/spa/share-p.jpg"
      }, function(response){});
      console.log('share');
  });
